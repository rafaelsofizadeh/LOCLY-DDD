...
exports.ConsoleNotificationService = void 0;
const common_1 = require("@nestjs/common");
const INotificationService_1 = require("./INotificationService");
let ConsoleNotificationService = class ConsoleNotificationService {
    constructor() { }
    templates = {
        [INotificationService_1.NotificationType.Auth]: ({ domain, token }) => `${domain}/auth/${token}`,
...
ConsoleNotificationService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [])
], ConsoleNotificationService);
exports.ConsoleNotificationService = ConsoleNotificationService;
